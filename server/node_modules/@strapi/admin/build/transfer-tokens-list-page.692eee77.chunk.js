"use strict";(self.webpackChunk_strapi_admin=self.webpackChunk_strapi_admin||[]).push([[9600],{12584:function(G,T,e){e.d(T,{Z:function(){return s}});var x=e(32735),c=e(35658),L=e(94547),l=e(19786),E=e(49372),D=e(87933),r=e(19565),j=e(60216),_=e.n(j),k=e(67879),P=e(53038),R=e(72850),S=e(50563),F=e(4038);const g=({tokenName:a,onClickDelete:o,tokenType:b})=>{const{formatMessage:v}=(0,k.Z)(),{trackUsage:h}=(0,r.rS)(),[n,i]=(0,x.useState)(!1),p=()=>{i(!1),h("willDeleteToken",{tokenType:b}),o()};return x.createElement(R.x,{paddingLeft:1,onClick:m=>m.stopPropagation()},x.createElement(S.h,{onClick:()=>{i(!0)},label:v({id:"global.delete-target",defaultMessage:"Delete {target}"},{target:`${a}`}),name:"delete",noBorder:!0,icon:x.createElement(F.Z,null)}),x.createElement(r.QH,{onToggleDialog:()=>i(!1),onConfirm:p,isOpen:n}))};g.propTypes={tokenName:_().string.isRequired,onClickDelete:_().func.isRequired,tokenType:_().string.isRequired};var B=g,J=e(54894),Z=e(8471);const X={edit:{id:"app.component.table.edit",defaultMessage:"Edit {target}"},read:{id:"app.component.table.read",defaultMessage:"Read {target}"}},V=(0,Z.ZP)(r.rU)`
  svg {
    path {
