...
const isWildCardConstant = (value) => value === '*';
...
const populate = (0, factory_1.default)()
    ...
    const visitedPopulate = await Promise.all(populate.map((nestedPopulate) => recurse(visitor, options, nestedPopulate)));
    return visitedPopulate.filter((item) => !(0, fp_1.isNil)(item));
})
    ...
    return {
        ...
        set(key, value, data) {
            ...
            return (0, fp_1.isNil)(value) || (0, fp_1.isEmpty)(value) ? root : `${root}.${value}`;
        },
        keys(data) {
